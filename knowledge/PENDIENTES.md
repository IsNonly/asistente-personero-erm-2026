...
| **Banco depurado para el Asistente del Personero ERM 2026** (40 preguntas en 7 bloques + 5 reglas operativas, revisado y corregido contra LOE / Res. 0850 / 0837 / 0838; documento de capacitación, no es norma oficial) | `OTROS/banco-depurado-asistente-personero.txt` | 41 entradas `bd-*` en `knowledge-base.json` (una por pregunta + `bd-cinco-reglas-cerebro`); se usaron las respuestas corregidas de las preguntas 2, 6, 21, 35, 38 y 40; las 5 reglas también se añadieron al prompt maestro. Las preguntas 37 y 40 textuales siguen respondiéndose con `copia-acta` y `actas-observadas`, que ya dan la respuesta depurada |
| **Manual operativo del Coordinador Zonal y Distrital de Personeros** (documento interno de la organización, no es norma oficial) | `OTROS/manual-coordinador-zonal-distrital.txt` | funciones-coordinador-zonal, funciones-coordinador-distrital, protocolo-5c-personeros, semaforo-incidencias-operativo, matriz-quien-resuelve-que, regla-80-20-coordinador-distrital |
